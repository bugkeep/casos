...
```bash
curl -fsSL https://raw.githubusercontent.com/bugkeep/casos/feat/one-click-installers/scripts/install.sh | bash
```

Windows PowerShell (x64 or arm64):

```powershell
irm https://raw.githubusercontent.com/bugkeep/casos/feat/one-click-installers/scripts/install.ps1 | iex
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/bugkeep/casos/feat/one-click-installers/scripts/install.sh | CASOS_VERSION=v1.32.0 INSTALL_DIR="$HOME/.local/bin" bash
```
