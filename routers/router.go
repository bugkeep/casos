...
func InitAPI() {
	...
	beego.Router("/api/add-managed-node", &controllers.ApiController{}, "POST:AddManagedNode")
	beego.Router("/api/preflight-managed-node", &controllers.ApiController{}, "POST:PreflightManagedNode")
	beego.Router("/api/get-managed-nodes", &controllers.ApiController{}, "GET:GetManagedNodes")
	beego.Router("/api/get-managed-node", &controllers.ApiController{}, "GET:GetManagedNode")
	beego.Router("/api/get-node-deploy-tasks", &controllers.ApiController{}, "GET:GetNodeDeployTasks")
	beego.Router("/api/get-node-deploy-logs", &controllers.ApiController{}, "GET:GetNodeDeployLogs")
	beego.Router("/api/repair-managed-node", &controllers.ApiController{}, "POST:RepairManagedNode")
	beego.Router("/api/remove-managed-node", &controllers.ApiController{}, "POST:RemoveManagedNode")
