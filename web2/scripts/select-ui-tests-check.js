...
expectSelection(
  ...
  ["controllers/machine.go", "object/machine_node_deploy.go", "web2/src/pages/MachineListPage.jsx"],
  ["tests/ui/worker-node.spec.js", "tests/ui/worker-node-ready.spec.js"]
);
...
expectSelection(
  ...
  ["web2/src/pages/SiteListPage.jsx", "web2/src/backend/SiteBackend.js", "object/site.go"],
...
expectSelection(
  ...
  [
    "web2/src/pages/AppStorePage.jsx",
    "web2/src/pages/DeploymentListPage.jsx",
    "web2/src/pages/ServiceListPage.jsx",
    "controllers/helm.go",
  ],
...
expectSelection(
  ...
  ["web2/src/components/shared/helm-install-dialog.jsx"],
  ["tests/ui/app-store.spec.js"]
);

expectSelection(
  "unknown frontend code changes run all regression tests",
  ["web2/src/pages/PodListPage.jsx"],
  ALL_REGRESSION_TESTS
);
...
expectSelection(
  ...
  ["web2/src/components/shared/data-table.jsx"],
  ALL_REGRESSION_TESTS
);

expectSelection(
  "shadcn primitive changes run all regression tests",
  ["web2/src/components/ui/button.jsx"],
  ALL_REGRESSION_TESTS
);
...
expectSelection(
  ...
  ["web2/scripts/select-ui-tests.js"],
  ALL_REGRESSION_TESTS
);
...
fs.writeFileSync(cliInputPath, "web2/src/components/shared/machine-node-deploy-sheet.jsx\n", "utf8");
try {
